...
uint256 hashGenesisBlock("0xf6658f92983cd6b343c47d65592ba7c7cf5a04fa9bc491d32c884a5d3a40d394");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 100000); // Dejacoin: 1M blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Dejacoin: 1 days
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd7a20838f252cb2bcd6f1385e1957b169f375181141d09f0708b865e33189e7d");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "dejacoin releases!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 20 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0452672eb1b67b9ea31cad7c2e7e2c5f063229483585a43c3e28907c990b8ac3d030b6d41b9b69aad89eaf9b4ab3e6b9108c2b2c1f89e758f906c1584a7c66b53a") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1646147614;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085673407;

        if (fTestNet)
        {
            block.nTime    = 1646147600;
            block.nNonce   = 385685910;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x384ddb019db041d87841b5aad3ecad038fe129abae11df9b2e5e87f5e2ff2e9c"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfl, 0xc2, 0xb4, 0xdu }; // Dejacoin: increase each by adding 2 to bitcoin's value.
